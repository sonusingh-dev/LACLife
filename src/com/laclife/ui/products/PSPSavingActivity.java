...
public class PSPSavingActivity extends HomeBaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_savings_psp);

		String product = getIntent().getStringExtra(
				Products.KEY_NAME_SORT_QUOTE);
