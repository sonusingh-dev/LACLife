...
public class ETPSavingActivity extends HomeBaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_savings_etp);
	...
	private void validate() {
		...
		mIntent.setClass(this, ETPAddRiskActivity.class);
