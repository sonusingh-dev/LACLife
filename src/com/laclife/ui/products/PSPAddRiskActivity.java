...
public class PSPAddRiskActivity extends HomeBaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_add_risk_psp);
	...
	public void onClick(View view) {
		mIntent.setClass(this, PSPFinalQuoteActivity.class);
